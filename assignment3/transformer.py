...
class Transformer(Model):
    ...
    def call(self, source_sequence, target_sequence, encoder_mask, decoder_mask, mask_future=True, shift_target_sequence_right=True):
        ...
        decoder_output = self.decoder(target_sequence, encoder_output, encoder_mask=encoder_mask,
                        decoder_mask=decoder_mask, shift_target_sequence_right=shift_target_sequence_right,
